...
- [x] 3.2 提交、构建并在 Niri 实机验证关闭、托盘恢复和后台保活
...
- [x] 阶段 3 完成后：静态检查、全量测试、release 构建、Niri 关闭到托盘与公网 MCP 探测均通过。
...
| 需求 ID | 设计章节 | 任务编号 | 状态 |
|---------|----------|----------|------|
| FR-1 | 架构设计、设计决策 1 | 1.1, 2.1, 2.2, 3.1, 3.2 | 完成 |
| FR-2 | API 设计、架构设计 | 1.1, 2.1, 2.2, 3.1, 3.2 | 完成 |
| FR-3 | 架构设计、测试策略 | 1.1, 2.1, 2.2, 3.1, 3.2 | 完成 |
